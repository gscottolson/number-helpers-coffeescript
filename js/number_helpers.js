  ...
  this.NumberHelpers = (function() {
    ...
    NumberHelpers.number_to_human = function(float, opts) {
      ...
      if (Math.pow(10, 3) > abs_float) {
        denom = 1;
        label = false;
      } else if ((Math.pow(10, 3) <= abs_float && abs_float < Math.pow(10, 6))) {
        denom = Math.pow(10, 3);
        label = 'Thousand';
      } else if ((Math.pow(10, 6) <= abs_float && abs_float < Math.pow(10, 9))) {
        denom = Math.pow(10, 6);
        label = 'Million';
      } else if ((Math.pow(10, 9) <= abs_float && abs_float < Math.pow(10, 12))) {
        denom = Math.pow(10, 9);
        label = 'Billion';
      } else if ((Math.pow(10, 12) <= abs_float && abs_float < Math.pow(10, 15))) {
